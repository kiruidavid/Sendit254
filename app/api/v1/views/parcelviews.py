...
def validate_string(string):
    """This function is used to validate if a user enters a string and no blank data"""
...
class DataDelivery(Resource, Parcel):
    ...
    def get(self): 
        """This is to get all the parcel order delieveries"""
...
class SingleDelivery(Resource, Parcel): 
    """This is to get a single parcel order"""
...
class SingleUser(Resource, Parcel): 
    """This is for getting a single user order with a user_id"""
...
class CancelDelivery(Resource, Parcel): 
    """This is a put update to update the status of the delivery to cancel"""
